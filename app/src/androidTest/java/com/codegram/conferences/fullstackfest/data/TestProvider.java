...
public class TestProvider extends AndroidTestCase {
    ...
    public void deleteAllRecordsFromProvider() {
        ...
        assertEquals("Error: Records not deleted from talks table during delete", 0, cursor.getCount());
        cursor.close();
        ...
        assertEquals("Error: Records not deleted from speakers table during delete", 0, cursor.getCount());
        cursor.close();
    }
    ...
    public void deleteAllRecordsFromDB() {
        ...
        db.delete(TalkEntry.TABLE_NAME, null, null);
        db.delete(SpeakerEntry.TABLE_NAME, null, null);
        db.close();
    }
